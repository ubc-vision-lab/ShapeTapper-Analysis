...
if __name__ == '__main__':
	...
	for turns in range(tunrz):
		ma_lines = old_lines
		txt2print = ''
		this_shape = []
		while len(this_shape) < 100:
			asd1 = [random.randint(1,size[1]), random.randint(1,size[0])]
			if cv2.pointPolygonTest(np.array(myCnt), tuple(asd1), False) > 0:
		...
		print txt2print1, txt2print3, txt2print2, txt2print4
