...
{
  pts2pts(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_pts2pts(PyObject *self, PyObject *args)
{
  float * x0;
  float const * x1;
  float const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "pts2pts", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_pts2pts _cffi_d_pts2pts
#endif
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__get_dists(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__get_dists(void) { return NULL; }
#  else
     init_get_dists(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__get_dists(void)
{
  return _cffi_init("_get_dists", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_get_dists(void)
{
  _cffi_init("_get_dists", 0x2601, &_cffi_type_context);
}
#endif
